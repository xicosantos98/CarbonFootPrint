...
function verifyBody(body) {
    if (body.hasOwnProperty('description') && body.hasOwnProperty('co2') && body.hasOwnProperty('unit')) {
        return true;
    } else {
        return false;
    }
...
router
    ...
    .get('/', function (req, res) {
        ...
        for (var i = 1; i <= count; i++) {
            ...
            costs.push({
                id: cost[0], CO2eq: co2, description: cost[3], unit: c_instance.units(cost[4].toNumber())[2]
            })
        }
    ...
    .post('/', function (req, res) {
        ...
        if (!verifyBody(req.body)) {
            ...
            try {
                c_instance.addCostType(co2eq, exp, req.body.description, req.body.unit, [], [], { from: req.headers.address, gas: 3000000 });
